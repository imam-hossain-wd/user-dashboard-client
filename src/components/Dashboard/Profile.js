...
const Profile = () => {
    return (
       <section>
		<h1 className='text-center font-bold text-rose-400 text-3xl my-5'>Welcome to Dashboard </h1>
		 <div className=" w-4/5 mx-auto  h-72 p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
